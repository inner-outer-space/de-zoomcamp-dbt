...
select 
    ...
    trips_unioned.extra + trips_unioned.mta_tax + trips_unioned.tolls_amount + trips_unioned.ehail_fee + trips_unioned.improvement_surcharge + trips_unioned.congestion_surcharge AS total_fees_and_tax
from trips_unioned
